/**
 * @file funkcijosClass.h
 * @author Naglis
 * @brief Pagalbinės funkcijos studentų pažymių valdymo sistemai class versijai
 * @version 0.1
 * @date 2025-12-11
 * 
...
/**
 * @brief Rikiuoja studentus pagal pažymius
 * 
 * @tparam Container 
 * @param studentai 
 */
...
/**
 * @brief Rikiuoja studentus pagal vardą
 * 
 * @tparam Container 
 * @param studentai 
 */
...
/**
 * @brief Išvedimo funkcija į vieną failą fiksuotu formatu
 * 
 * @tparam Container 
 * @param studentai 
 */
...
/**
 * @brief Išvedimo funkcija į konsolę fiksuotu formatu išveda studentų duomenis
 * 
 * @tparam Container 
 * @param studentai 
 */
...
/**
 * @brief Išvedimo funkcija į du failus fiksuotu formatu, išveda studentų duomenis į du atskirus failus
 * 
 * @tparam Container 
 * @param zem_lyg Studentai, kurių vidurkis mažesnis nei 5.0
 * @param aukst_lyg Studentai, kurių vidurkis lygus arba didesnis nei 5.0
 * @param varg_file failas į kurį išvedami neišlaikę studentai
 * @param kiet_file failas į kurį išvedami išlaikę studentai
 */
template <typename Container>
...
/**
 * @brief Skirsto studentus į dvi grupes pagal galutinį vidurkį
 * 
 * @tparam Container 
 * @param studentai vectorius su studentais
 * @param zem_lyg vectorius, į kurį bus įdėti studentai su žemu vidurkiu
 * @param aukst_lyg vectorius, į kurį bus įdėti studentai su aukštu vidurkiu
 */
template <typename Container>
...
/**
 * @brief Rikiuoja studentus pagal pasirinkimą: vardas arba pažymiai
 * 
 * @tparam Container 
 * @param sort_type 
 * @param studentai 
